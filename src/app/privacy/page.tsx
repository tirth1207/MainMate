            ...
            <>
                <div className="max-w-5xl px-8 mx-auto sm:mt-10">
                    ...
                    <p className="text-justify leading-relaxed text-gray-600 mt-5 mb-10">
                        MailMate (“MailMate,” “we,” “us,” or “our”) we value your privacy and are committed to protecting
                    ...
                    <p className="text-justify leading-relaxed text-gray-600 mt-5 mb-10">
                        ...
                        on www.mailmate.com and other sites.
                    </p>
                    <h3 className="text-left text-2xl font-semibold text-gray-600 mb-5">
                        Children
                    </h3>
                    ...
                    <p className="text-justify leading-relaxed text-gray-600 mt-5 mb-10">
                        ...
                        MailMate’s legitimate business purposes, and only on a need-to-know basis. When sharing personal information,
                    ...
                    <ul className="list-disc list-inside text-justify leading-relaxed text-gray-600 mt-5 mb-10">
                        ...
                        <li>submit a complaint to MailMate if you are not satisfied with how we are processing your personal
                            information.</li>
                    </ul>
                    <h3 className="text-left text-2xl font-semibold text-gray-600 mb-5">
